    ...
    \column{0.5\textwidth}
      \begin{itemize}
        ...
        \begin{itemize}
          ...
          \mypause
          \item Deep learning methods (PyTorch: CNN, U-net, Residual U-net)
          \mypause
          \item Combination
        \end{itemize}
        \mypause
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \mypause
    \begin{itemize}
      \item Reduce computational needs\mypause~\textrightarrow~prune network, decrease input size\mypause
